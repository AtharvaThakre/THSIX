...
6. `⚡ MASTER TANDEM PLAYBOOK — PRE-BUILT COMBOS BY PROJECT TYPE {#tandem-playbook}` - 14 edges
7. `react` - 13 edges
...
### Community 0 - "App.tsx"
Cohesion: 0.06
Nodes (39): gsap, lenis, lucide-react, react, react-router-dom, App(), HomePage(), raf() (+31 more)

### Community 1 - "package.json"
Cohesion: 0.05
Nodes (37): devDependencies, oxlint, @types/node, @types/react, @types/react-dom, typescript, vite, @vitejs/plugin-react (+29 more)
...
## Knowledge Gaps
- **342 isolated node(s):** `$schema`, `plugins`, `react/rules-of-hooks`, `react/only-export-components`, `name` (+337 more)
...
- **Why does `lucide-react` connect `App.tsx` to `ProductCard.tsx`, `package.json`, `BrandCard.tsx`, `Hero.tsx`?**
